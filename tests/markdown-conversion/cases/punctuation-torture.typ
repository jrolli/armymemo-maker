...
1. Inline markup characters must render literally: \# \$ \* \_ \[ \] \< \> \@ \~ \/ and a backslash \\ plus straight "double" and 'single' quotes.
2. URLs and paths survive: https:\/\/example.mil\/a\_b\/c.pdf and \/\/server\/share and the sum \$5 + \$10 = \$15 or \~15 dollars at 100%.
3. A hard break, then\
...
- A bulleted list whose item wraps onto a second source line, and one with \#emph\[fake Typst\] inside.
